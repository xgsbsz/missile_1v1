...
from ..tasks.intercept_task import InterceptTask
...
class SingleControlEnv(BaseEnv):
    ...
    def __init__(self, config_name: str):
        ...
        assert len(self.agents.keys()) == 4, f"{self.__class__.__name__} only supports 2 aircraft!"
    ...
    def load_task(self):
        ...
        elif taskname == 'intercept': #intercepttask 加载任务
            self.task = InterceptTask(self.config) #TODO
        else:
